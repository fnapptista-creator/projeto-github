...
export default function RepresentacaoClient() {
        ...
        <>
            <section className={styles.hero}>
                <div className={styles.heroContent}>
                    ...
                    <p className={styles.heroSubtitle}>
                        Curadoria de marcas líderes para Cama, Mesa e Banho, Petshop, Utilidades, Decoração e Foodservice. Abasteça sua loja com o que há de melhor no mercado.
                    </p>
                </div>
            </section>
            ...
            <section className={styles.ctaSection}>
                <div className="container">
                    ...
                    <p style={{ marginBottom: '2rem', color: '#000000ff' }}>Tenho acesso a um portfólio ainda maior de parceiros.</p>
                    <a
