    ...
    return (
        <section className="py-24 bg-[#050505] relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="flex overflow-x-auto snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] md:grid md:grid-cols-3 gap-4 md:gap-8 border-t border-white/[0.05] pt-12 mt-12 pb-4 -mx-6 px-6 md:mx-0 md:px-0 scroll-smooth">
