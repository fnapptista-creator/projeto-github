            ...
            >
                ...
                <div className="flex justify-center">
                    ...
                    >
                        ...
                        <div className="w-8 h-8 rounded-full shadow-[0_0_10px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_10px_rgba(255,255,255,0.3)] bg-white/5 items-center justify-center transition-all duration-300 hidden sm:flex">
