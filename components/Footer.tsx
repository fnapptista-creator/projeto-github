            ...
            <div className="container mx-auto px-6 md:px-12 py-8 md:py-12 relative z-10 flex flex-col lg:flex-row justify-between items-start gap-8">
                ...
                <div className="flex flex-col space-y-8 w-full lg:w-1/2">
                    ...
                    <div>
                        ...
                        <span className="text-[10px] uppercase tracking-[0.15em] text-[#888] font-bold font-sans">Consultor Gastronômico</span>
                    </div>

                    {/* Contacts List */}
                    <ul className="flex flex-col space-y-5 text-sm md:text-[15px] text-white/80 font-sans font-light">
                        <li>
